...
//     version 1.4.4
//     from Assets/_Scripts/Units/Player/Vlad/NewInputSystem/PlayerControlls.inputactions
//
...
public partial class @PlayerInputControlls : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Dash"",
                    ""type"": ""Button"",
                    ""id"": ""09dcb0ea-a677-40ba-a6c9-e174eb71fd7b"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""36a07bfb-b606-4303-ad37-b92645c42f20"",
    ...
    ""controlSchemes"": []
        ...
        m_PlayerGameProcess_Dash = m_PlayerGameProcess.FindAction("Dash", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_PlayerGameProcess_Dash;
    public struct PlayerGameProcessActions
    {
        ...
        public InputAction @Dash => m_Wrapper.m_PlayerGameProcess_Dash;
        ...
        public void SetCallbacks(IPlayerGameProcessActions instance)
        {
            if (m_Wrapper.m_PlayerGameProcessActionsCallbackInterface != null)
            {
                ...
                @Dash.started -= m_Wrapper.m_PlayerGameProcessActionsCallbackInterface.OnDash;
                @Dash.performed -= m_Wrapper.m_PlayerGameProcessActionsCallbackInterface.OnDash;
                @Dash.canceled -= m_Wrapper.m_PlayerGameProcessActionsCallbackInterface.OnDash;
            }
